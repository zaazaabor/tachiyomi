...
internal class ExtensionInstaller(private val context: Context) {
   ...
   */
  private val downloadsRelay = PublishSubject.create<Pair<Long, InstallStep>>()
  ...
  fun setInstallationResult(downloadId: Long, result: Boolean) {
    ...
    downloadsRelay.onNext(downloadId to step)
  }
  ...
  private inner class DownloadCompletionReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent?) {
      ...
      if (uri != null) {
        downloadsRelay.onNext(id to InstallStep.Installing)
      } else {
        Timber.e("Couldn't locate downloaded APK")
        downloadsRelay.onNext(id to InstallStep.Error)
        return
      }
